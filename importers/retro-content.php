...
<div class="wrap">
	<h1><?php esc_html_e( 'Retroactive Content', 'mycred_retro' ); ?> <a href="<?php echo esc_url(admin_url( 'import.php' )); ?>" class="page-title-action"><?php esc_html_e( 'All Tools', 'mycred_retro' ); ?></a></h1>
...
?>
	<div id="message" class="updated notice"><p><?php esc_html_e( 'No content found.', 'mycred_retro' ); ?></p></div>
<?php
...
?>
	<form id="import-upload-form" method="post" action="">
		<table class="wp-list-table widefat fixed striped users">
			<thead>
				<tr>
					<th style="width: 30%;"><?php esc_html_e( 'Post Type', 'mycred_retro' ); ?></th>
					...
					<th style="width: 10%;"><?php esc_html_e( 'Content', 'mycred_retro' ); ?></th>
				</tr>
			</thead>
			<tbody>
				<tr>
					<td>
						<select name="mycred_retro[post_type]" id="select-content-type" class="form-control">
							<option value="" data-template="" data-count=""><?php esc_html_e( 'Select Post Type', 'mycred_retro' ); ?></option>
<?php
				...
				foreach ( $content as $entry ) {
					...
					echo '<option value="' . esc_attr($entry->post_type) . '" data-template="%plural% for published %post_type%" data-count="' . esc_attr($entry->total) . '">' . esc_html($post_type->labels->name) . '</option>';
...
?>
					...
					<td>
						<input type="text" name="mycred_retro[amount]" placeholder="<?php esc_html_e( 'amount', 'mycred_retro' ); ?>" id="content-log-amount" class="form-control" value="" />
					</td>
					<td>
						<input type="text" name="mycred_retro[log_template]" id="content-log-template" placeholder="<?php esc_html_e( 'no log entry', 'mycred_retro' ); ?>" class="form-control" value="" />
					</td>
					<td id="content-count"><h5><?php echo esc_html($total); ?></h5></td>
				</tr>
			</tbody>
		</table>
		<p>
			<label for="content-original-date"><input type="checkbox" name="mycred_retro[date]" id="content-original-date" checked="checked" value="1" /> <?php esc_html_e( 'When adding a log entry, use the date the content was published, and not the current date.', 'mycred_retro' ); ?></label>
		</p>
		...
		<div id="task-status" style="display: none;">
			...
			<table class="wp-list-table widefat fixed striped users" id="task-progress-table">
				<thead>
					<tr>
						<th style="width: 20%;"><?php esc_html_e( 'Eligible Content', 'mycred_retro' ); ?></th>
